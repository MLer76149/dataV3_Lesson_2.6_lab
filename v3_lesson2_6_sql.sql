...
that there is Christian Arkoyd, Kirsten Arkoyd, and Debbie Arkoyd. 
...
question but this time we want to include the last names of the actors where the last name was 
...
select staff_id, count(*) as rentals_amount from rental
group by staff_id;
